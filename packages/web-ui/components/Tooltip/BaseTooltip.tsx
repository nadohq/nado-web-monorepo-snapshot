...
export interface BaseTooltipProps extends BaseTestProps, WithChildren {
        ...
        <div
          {...getTooltipProps({
            className: mergeClassNames(
              'text-text-tertiary shadow-elevation-strong rounded-sm',
              // tooltip-container defines line-height (leading-normal)
              // this needs to be defined in the base CSS as TooltipPortal conflicts somehow
              'tooltip-container',
