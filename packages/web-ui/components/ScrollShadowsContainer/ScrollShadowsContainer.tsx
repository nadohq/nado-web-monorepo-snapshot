...
export function ScrollShadowsContainer({
  ...
  const overflowClassNames = {
    vertical: 'overflow-y-auto overflow-x-hidden no-scrollbar',
    horizontal: joinClassNames(
      'overflow-x-auto overflow-y-hidden',
      // We want horizontal scrollbar on larger screens so that non-Mac devices can scroll easily
