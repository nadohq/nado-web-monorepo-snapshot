...
export function mapCustomFormatSpecifier(
  ...
  switch (formatSpecifier as CustomNumberFormatSpecifier) {
    ...
    case CustomNumberFormatSpecifier.SIGNED_CURRENCY_INT:
      if (isZero) {
        return PresetNumberFormatSpecifier.CURRENCY_INT;
      }
      return PresetNumberFormatSpecifier.SIGNED_CURRENCY_INT;
    ...
    case CustomNumberFormatSpecifier.SIGNED_CURRENCY_LARGE_ABBREVIATED:
      if (isZero) {
        return PresetNumberFormatSpecifier.CURRENCY_2DP;
      }
      if (isLargeSizeClassOrGreater) {
        return PresetNumberFormatSpecifier.SIGNED_CURRENCY_SI_3SF;
      }
      return PresetNumberFormatSpecifier.SIGNED_CURRENCY_2DP;
  }
}
