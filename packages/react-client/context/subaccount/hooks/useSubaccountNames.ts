...
import { useQueryListSubaccounts } from '../../../hooks/query/subaccount/useQueryListSubaccounts';
import { PRIMARY_SUBACCOUNT_NAME } from '../../../modules/subaccounts/consts';
import { isAppSubaccountName } from '../../../modules/subaccounts/utils/isAppSubaccountName';
import { isIsoSubaccountName } from '../../../utils';
...
export function useSubaccountNames(): UseSubaccountNames {
  const { data: subaccounts } = useQueryListSubaccounts();
