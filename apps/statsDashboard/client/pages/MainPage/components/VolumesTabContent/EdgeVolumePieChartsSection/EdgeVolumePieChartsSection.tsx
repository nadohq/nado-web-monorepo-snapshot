  ...
  return (
    <StatsSection className="sm:grid-cols-2">
      <StatsPieChart
        ...
        chartDescription="Breakdown of volume across different markets in past 24h."
        isLoading={isLoading}
        centerContent={
      ...
      <StatsPieChart
        ...
        chartDescription="Breakdown of volume across different markets in the past 7 days."
        centerContent={
          <StatsPieChartCenterMetric
            label="7d Vol."
      ...
      <StatsPieChart
        ...
        chartDescription="Breakdown of volume across different markets in the past 30 days."
        centerContent={
          <StatsPieChartCenterMetric
            label="30d Vol."
      ...
      <StatsPieChart
        ...
        chartDescription="Breakdown of cumulative volume across different markets."
        centerContent={
          <StatsPieChartCenterMetric
            label="All Time Vol."
