  ...
  return (
    <StatsSection className="sm:grid-cols-2">
      <StatsChart
        ...
        chartDescription={`The ${granularityLabel} perp and spot trading volume.`}
      ...
      <StatsChart
        ...
        chartDescription="The cumulative trading volume of perpetual and spot markets over time."
