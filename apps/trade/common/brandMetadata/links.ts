export const LINKS = {
  ...
  fastWithdrawalsLearnMore: `https://docs.nado.xyz/fees-and-rebates#fast-withdrawals`,
  feeTiersDocs:
    'https://docs.nado.xyz/fees-and-rebates#trading-fees-and-scaling-tiers',
  hacken: 'https://hackenproof.com/programs/nado-smart-contracts',
  maintenanceWindowDocs: 'https://docs.nado.xyz/maintenance-windows',
  marketingSite: 'https://nado.xyz',
  may15DelistInfo: '',
  multipleSubaccountsDocs: 'https://docs.nado.xyz/subaccounts-and-health',
  onboardingTutorial: 'https://docs.nado.xyz/onboarding-tutorial',
