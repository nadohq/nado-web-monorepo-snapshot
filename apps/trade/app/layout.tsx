...
export default function AppLayout({ children }: WithChildren) {
  return (
    <AppRootLayout>
      <AppProviders>
        {/* AppProviders mounts FunkitProvider internally, which injects a `data-rk` div around
            children. This recreates the app shell flex column inside it so content can size correctly. */}
