import { CARD_CLASSNAMES } from '@nadohq/web-ui';
...
// All general styling is managed within the library's CSS files and we only add a background-color to the bullet by selecting this className
...
export const COMMON_SWIPER_PROPS: Partial<SwiperProps> = {
  ...
  speed: 1000,
  // Navigation is driven by our custom `SwiperNavigation` component, so disable
  // the built-in SVG arrow icons that Swiper v12+ injects into nav buttons by default.
  navigation: {
    addIcons: false,
  },
  autoplay: {
