...
import {
  ...
  UtmCampaignID,
} from 'client/modules/utm/dialogs/UtmCampaignDialog/UtmCampaignDialog';
...
export function UtmQueryParamsListener() {
  ...
  useEffect(() => {
    if (
      ...
      // Only show the dialog if the campaign is enabled
      ENABLED_CAMPAIGN_IDS.includes(campaignId)
    ) {
