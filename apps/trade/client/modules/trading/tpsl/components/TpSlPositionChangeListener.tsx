...
export function TpSlPositionChangeListener() {
  ...
  const { data: currentSubaccountSummary } = useQuerySubaccountSummary();
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- Track mutation state before firing to prevent duplicate calls
