...
import { TpSlEstimatedPnlContent } from 'client/modules/trading/tpsl/components/TpSlEstimatedPnlContent';
import { TpSlGainOrLossInputTypeSelect } from 'client/modules/trading/tpsl/components/TpSlGainOrLossInputTypeSelect';
import { TpSlPnlFractionSlider } from 'client/modules/trading/tpsl/components/TpSlPnlFractionSlider';
...
export function TpSlDialogPriceInputs({
  form,
  priceState,
  isTakeProfit,
  priceIncrement,
  ...
  return (
    <div className="flex flex-col gap-y-2">
      ...
      <TpSlPnlFractionSlider form={form} priceState={priceState} />
      <TpSlEstimatedPnlContent priceState={priceState} />
    </div>
  );
}
