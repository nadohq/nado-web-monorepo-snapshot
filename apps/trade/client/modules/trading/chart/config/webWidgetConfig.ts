...
import { ResolutionString, WidgetOverrides } from 'public/charting_library';
...
const WIDGET_STYLING: WidgetConfig['styling'] = {
  ...
  '--tv-color-toolbar-button-background-hover':
    getResolvedColorValue('surface-1'),
  '--tv-color-toolbar-button-background-active':
    getResolvedColorValue('surface-2'),
  ...
  '--tv-color-toolbar-button-background-expanded':
    getResolvedColorValue('surface-2'),
  '--tv-color-toolbar-button-text': getResolvedColorValue('text-tertiary'),
  ...
  '--tv-color-toolbar-button-text-active-hover':
    getResolvedColorValue('text-primary'),
  '--tv-color-item-active-text': getResolvedColorValue('text-primary'),
  ...
  '--tv-color-popup-background': getResolvedColorValue('surface-1'),
  ...
  '--tv-color-popup-element-secondary-text':
    getResolvedColorValue('text-tertiary'),
  ...
  '--tv-color-popup-element-background-active':
    getResolvedColorValue('surface-3'),
...
const WIDGET_OVERRIDES: Partial<WidgetOverrides> = {
...
export const WEB_WIDGET_CONFIG: WidgetConfig = {
