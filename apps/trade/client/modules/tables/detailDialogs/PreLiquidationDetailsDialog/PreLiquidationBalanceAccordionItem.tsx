import { joinClassNames, NextImageSrc } from '@nadohq/web-common';
...
export function PreLiquidationBalanceAccordionItem({
  ...
  return (
    <Accordion.Item value={value}>
      <Card className="text-text-secondary bg-surface-1 flex flex-col p-0">
        ...
        <Accordion.Content className="flex flex-col gap-y-2 p-2">
          {metrics}
        </Accordion.Content>
      </Card>
    </Accordion.Item>
