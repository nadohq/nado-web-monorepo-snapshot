...
interface DitherProps extends WithClassnames {
  waveSpeed?: number;
  waveFrequency?: number;
  waveAmplitude?: number;
  waveColor?: [number, number, number];
...
/**
 * From https://reactbits.dev/backgrounds/dither
 *
 * This is exported as default to simplify lazy loading.
 * Consider loading this component lazily as threejs is a large dependency.
 */
