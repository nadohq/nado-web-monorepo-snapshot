...
const config = {
  ...
  options: {
    ...
    doNotFollow: {
      ...
      /* `dist` is required for local SDK linking, not that checking build */
      /* would be a good idea anyway (similarly to checking .next/) */
      path: ['node_modules', '.next', 'public', 'dist'],
    },
